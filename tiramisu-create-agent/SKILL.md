...
`skills/tiramisu-create-agent/references/agent-instruction-templates.md`

Generic fallback for no-template hires:
`skills/tiramisu-create-agent/references/baseline-role-guide.md`
...
`skills/tiramisu-create-agent/references/draft-review-checklist.md`
...
- Template index and how to apply a template: `skills/tiramisu-create-agent/references/agent-instruction-templates.md`
- Software role templates: `skills/tiramisu-create-agent/references/agents/software/`
- Board game role templates: `skills/tiramisu-create-agent/references/agents/boardgame/`
- Playtester archetypes: `skills/tiramisu-create-agent/references/agents/boardgame/playtester-archetypes/`
- Generic baseline role guide (no-template fallback): `skills/tiramisu-create-agent/references/baseline-role-guide.md`
- Pre-submit draft-review checklist: `skills/tiramisu-create-agent/references/draft-review-checklist.md`
- Endpoint payload shapes and full examples: `skills/tiramisu-create-agent/references/api-reference.md`
